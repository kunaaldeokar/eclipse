...
/**
 * This class is totally for the practice purpose.
 * Changes in this class should not be consider as a part of knowledge.
 */
...
List<Employee> list = new ArrayList<Employee>();
		...
		list.add(new Employee(133, "Jyothi", 30, "Male", "Infrastructure", 2012, 18000.0));
		list.add(new Employee(144, "Murali", 28, "Male", "Product Development", 2014, 44500.0));
		...
		list.add(new Employee(222, "Nitin", 23, "Male", "Product Development", 2016, 28200.0));
		...
		List<String> result = list.stream().map(Employee::getDepartment).distinct().toList();
